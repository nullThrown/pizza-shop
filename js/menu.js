...
addToCartBtns.forEach((btn) => {
  btn.addEventListener('click', (e) => {
    ...
    let cartItem = new CartItem(uuid, foodItem.name, sizeSelectEl, crustSelectEl, sauceSelectEl, countEl.value, originalPrice, totalPrice, foodItem.imageLink);
    setItemToLocalStorage(cartItem);
    activateCartCount();
