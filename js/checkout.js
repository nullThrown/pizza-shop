...
// convert this into a string -> html conversion
...
// this should be a string -> html conversion
...
// this needs to be separate piece of logic
function renderOrderType() {
  let cart = getObjFromLocalStorage('cart');
  orderTypeSpan.textContent = cart.orderType;
}
// maybe abstract these with other pickup/delvery btns on homepage
// if not combine them into single e listener
